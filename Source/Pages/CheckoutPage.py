...
from myvenv6.ssqatest.src.pages.locators.CheckoutPageLocators import CheckoutPagelocators
import time
...
class CheckoutPage(CheckoutPagelocators):
    ...
    def input_billing_street_address_1(self,address1=None):
        address1=address1 if address1 else '123 Main street'
    ...
    def fill_in_billing_info(self, f_name=None, l_name=None, street1=None, city=None, zip_code=None, phone=None,
        ...
        self.input_billing_email(email='Vignesh123@gmail.com')
